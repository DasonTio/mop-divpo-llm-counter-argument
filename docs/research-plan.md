...
|---|---|---|---|---|
| 1 | `scripts/experiment_persona_distinctness.py` | Create | New | TODO |
| 2 | `src/mop_divpo/eval/llm_judge.py` | Create | New | TODO |
| 3 | `src/mop_divpo/eval/llm_judge_rubrics.py` | Create — store rubric prompts as constants | New | TODO |
| 4 | `scripts/run_baseline_evaluation.py` | Create — wires generation + metrics + judge into the table | New | TODO |
| 5 | `tests/test_llm_judge.py` | Create — unit-test rubric parsing and cache behaviour | New | TODO |
| 6 | `outputs/experiments/persona_distinctness.json` | Generated by #1 | Output | TODO |
| 7 | `outputs/evaluation/baseline_table.{json,csv,md}` | Generated by #4 | Output | TODO |
